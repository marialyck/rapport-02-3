...
public class TestProjectAdministration {
	...
	public void testProjectName() throws Exception {
		...
		try {
			...
			assertEquals("Error: You must enter a valid name for your project",
					e.getMessage());
	...
	public void testAddProject() throws Exception {
		...
		proApp.createProject("PlantTrees", 2015, 1, 2017, 1);
	...
	public void testFollowUp() throws Exception {
		ProjectManagementApp proApp = new ProjectManagementApp();
		Employee emp1 = new Employee("Rapunzel", proApp);
		Employee emp2 = new Employee("Cinderella", proApp);

		proApp.addEmployee(emp1);
		proApp.addEmployee(emp2);

		proApp.createProject("FairyTale", 2015, 1, 2017, 1);

		Project pro1 = proApp.getProjects().get(0);

		pro1.setProjectLeader(emp1);
		Cal cal = new Cal();
		Activity act1 = new Activity("RescuePrincess", 420, 2015, 2, 2016, 2);
	...
	public void testGetReport() throws Exception {
		ProjectManagementApp proApp = new ProjectManagementApp();
		Employee emp1 = new Employee("Donkey", proApp);
		Employee emp2 = new Employee("Shrek", proApp);
		Project pro1 = new Project("FeedDragon", 2015, 1, 2017, 1);
		Cal cal = new Cal();
		Activity act1 = new Activity("GatherMeatForDragon", 420, 2015, 2, 2016, 2);
		pro1.setProjectLeader(emp1);
		// step 1) an employee tries to add a crew to a project but the employee
		// is not a project leader

		proApp.createProject("RescueFiona", 2015, 1, 2017, 1);
